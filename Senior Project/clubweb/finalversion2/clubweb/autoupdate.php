...
NEW: $weekday can be changed depends on new table in db defday(dafault day)
in dafday there are always two rows:
   date,  day,   isNew
1) 	   ,$weekday,  0
2)     , new day,  1
when we find a new weekday then $weekday = new day
elso $weekday = it self
