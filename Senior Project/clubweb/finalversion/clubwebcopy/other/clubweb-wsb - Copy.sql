...
CREATE TABLE `checkouts` (
  ...
  KEY `dateId` (`dateId`),
  KEY `userId` (`userId`),
  CONSTRAINT `checkouts_ibfk_1` FOREIGN KEY (`dateId`) REFERENCES `dates` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `checkouts_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
...
--
-- Table structure for table `defday`
--
DROP TABLE IF EXISTS `defday`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `defday` (
  `date`    int(10) unsigned NOT NULL,
  `weekday` int(1)  unsigned NOT NULL,
  `isnew`   int(1)  unsigned NOT NULL,
   PRIMARY KEY (`isnew`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
--
-- Dumping data for table `defday`
--
LOCK TABLES `defday` WRITE;
/*!40000 ALTER TABLE `defday` DISABLE KEYS */;
INSERT INTO `defday` VALUES (1445814000,1,0),(1445814000,1,1);
/*!40000 ALTER TABLE `defday` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `uinfo` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`),
  CONSTRAINT `uinfo_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
