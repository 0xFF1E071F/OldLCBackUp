<?php
	...
	*/
	...
	function listAttendees ($databaseConnection, $uid_checkout_array)
	{
		//select names from database userinfo
		$sql_uinfo = "SELECT id,f_name,l_name,uid from uinfo ORDER BY f_name;";
		$result_uinfo = mysqli_query($databaseConnection,$sql_uinfo);
				...
				<?php //include('reload.php'); ?>
					<table class="calender">
						...
						<tr>
							...
							<!--name list-->
							<td class="name" >
								<?php 	listAttendees ($conn,$uid_checkout_array);	?>
							</td>
						</tr>
						<?php
						}
